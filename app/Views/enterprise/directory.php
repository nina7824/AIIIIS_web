...
<section class="enterprise-nav">
    <div class="container">
        <div class="nav-items">
            ...
            <a href="<?= base_url('enterprises/directory') ?>" class="active">Enterprise Directory</a>
...
<section class="page-header">
    <div class="container">
        ...
        <p>Browse and search the complete directory of registered enterprises in Rwanda.</p>
    </div>
</section>
...
<section class="content-placeholder">
    <div class="container">
        ...
        <h3>Enterprise Directory Coming Soon</h3>
        <p>This feature is currently under development. Check back soon for the complete enterprise directory with advanced search and filtering capabilities.</p>
    </div>
</section>
<?= $this->endSection() ?>