...
<section class="chat-section">
    <div class="container">
            ...
            <div class="chat-header">
                <div class="chat-info">
                    ...
                    <div class="chat-user-info">
                        ...
                        <span class="status">
                            <span class="dot"></span> 
                            <span id="supportStatus">Online — AI Powered Chatbot</span>
                        </span>
                    </div>
                </div>
        ...
        $whatsappNumbers = [
            ...
            'investor-matchmaking' => '+250792459886'
        ];
        
        // Define Email addresses for each service
        $emailAddresses = [
            'operations-followup' => 'amandin.mihigo.gov.rw',
...
// Send message function - Uses AI Chatbot (Knowledge Base Only)
